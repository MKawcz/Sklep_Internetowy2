    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-12">
                <h4 class="font-rubik font-size-20">Sklep Internetowy</h4>
            ...
            <div class="col-lg-4 col-12">
                ...
                <form class="form-row">
                    ...
                    <div class="col mt-2">
                        <button type="submit" class="btn btn-primary mb-2">Subskrybuj
                        </button>
                    </div>
                </form>
            </div>
...
<div class="copyright text-center bg-dark text-white py-2">
    <p class="font-rale font-size-14">&copy; Copyrights 2022. Desing By <a href="#" class="color-second">Mikołaj Kawczyński</a></p>
</div>
<!--!start #footer-->
